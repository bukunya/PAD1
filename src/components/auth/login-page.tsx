              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <FeatureItem icon={BookOpen} text="Pengajuan ujian online" />
                    <FeatureItem icon={Users} text="Koordinasi dosen pembimbing" />
                    <FeatureItem icon={Shield} text="Akses aman dengan akun UGM" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="w-full max-w-md mx-auto">
                ...
                <Card className="border-none shadow-none bg-gray-50">
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardDescription>Masuk dengan akun Google UGM Anda</CardDescription>
                  </CardHeader>
                  ...
                  <CardFooter className="flex-col space-y-4">
                    <p className="text-xs text-gray-500 text-center">
                      ...
                      <span className="font-semibold text-blue-600">@ugm.ac.id</span> dan{" "}
                      <span className="font-semibold text-blue-600">@mail.ugm.ac.id</span>{" "}
