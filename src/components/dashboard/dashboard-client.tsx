...
const StatusNotification = dynamic<any>(
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {userRole !== "ADMIN" && notifications && (
            <div className="h-[625px]">
              <StatusNotification notifications={notifications} role={userRole} />
            </div>
          )}
        </div>
        ...
        <div className="lg:col-span-2">
          <Calendar upcomingExams={topData?.data || []} role={userRole} />
        </div>
      </div>

      {/* Bottom Full-Width Section */}
      <BottomSection role={userRole} bottomData={bottomData} />
    </div>
  );
}